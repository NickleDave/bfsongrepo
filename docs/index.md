...
This dataset consists of song from four adult (>100-d-old) male 
...
A schema was created for each individual bird's song (see .tif files). 
...
use of the label 'e' in the song of gy6or6 and bl26lb16 
...
While labeling the entire dataset, 
...
Nicholson, David; Queen, Jonah E.; J. Sober, Samuel (2017): Bengalese Finch song repository. figshare. Dataset. 
   https://doi.org/10.6084/m9.figshare.4805749.v7 
...
Each .cbin file also has associated .tmp and .rec files, 
also created by EvTAF. 
Those files are not strictly required to work with this dataset 
